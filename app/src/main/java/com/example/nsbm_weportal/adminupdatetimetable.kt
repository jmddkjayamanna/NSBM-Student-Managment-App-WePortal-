...
class adminupdatetimetable : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_adminupdatetimetable)
        Menu()
    }
    private fun Menu()
    {
        val drawerLayout: DrawerLayout = findViewById(R.id.drawerLayoutL4)
        val navView: NavigationView = findViewById(R.id.nav_viewL4)
        val btn=findViewById<Button>(R.id.menul4)
