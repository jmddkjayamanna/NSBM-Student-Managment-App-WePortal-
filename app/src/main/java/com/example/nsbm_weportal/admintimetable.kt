...
class admintimetable : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admintimetable)
        Menu()

        var addbtn=findViewById<ImageButton>(R.id.addtime2)
        addbtn.setOnClickListener {
            val intent3 = Intent(this, adminaddtimetable::class.java)
            startActivity(intent3)
        }
    }
    private fun Menu()
    {
        val drawerLayout: DrawerLayout = findViewById(R.id.drawerLayoutL5)
        val navView: NavigationView = findViewById(R.id.nav_viewL5)
        val btn=findViewById<Button>(R.id.menul5)
