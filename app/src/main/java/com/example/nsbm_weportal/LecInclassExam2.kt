...
class LecInclassExam2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lec_inclass_exam2)
        Menu()
    }
    private fun Menu()
    {
        val drawerLayout: DrawerLayout = findViewById(R.id.drawerLayoutA3)
        val navView: NavigationView = findViewById(R.id.nav_viewA3)
        val btn=findViewById<Button>(R.id.menuA3)
